 ...
 * @author Shai Almog
 */
public class SocialChatStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "SocialChat";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new SocialChatStub());
    }
